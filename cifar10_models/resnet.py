...
class PreActBlock_reg(nn.Module):
    expansion = 1

    def __init__(self, in_planes, planes, stride=1):
        super(PreActBlock_reg, self).__init__()
        self.bn1 = nn.BatchNorm2d(in_planes)
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.linear = nn.Linear(self.expansion*planes,1)
    ...
    def forward(self, x):
        ...
        # append
        N, C, H, W = out.shape 
        mask = self.linear.weight
        out = out * mask.view(1,C,1,1)
...
class BasicBlock_reg(nn.Module):
    expansion = 1

    def __init__(self, in_planes, planes, stride=1):
        super(BasicBlock_reg, self).__init__()
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        # self.linear_weight = nn.Linear(self.expansion*planes,1)
...
def PreActResNet18():
    return ResNet(PreActBlock, num_blocks = [2,2,2,2])
...
def ResNet152():
    return ResNet(Bottleneck, num_blocks = [3,8,36,3])